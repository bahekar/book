...
(function($) {
				...
				f = {
					...
					_thumbCreator: {
						create: function(i) {
                                                 ...
                                                 var file_desc=$("#custom-caption-upload").val();
                                                //  var file_desc=f.files[i].desc;
                                                //  alert(file_desc);
                                                   $("#custom-caption-upload").val("");
                                                    //$("#captionfile").val(file_desc);
                                                    var obj = {};
                                                    obj[f.files[i].name] = file_desc;
                                                    //console.log(obj);
                                                    elemsdesc.push(obj);
							...
							var file = f.files[i],
								...
								progressBar = n.uploadFile ? '<div class="jFiler-jProgressBar">' + n.templates.progressBar + '</div>' : '',
									...
									image: '<div class="jFiler-item-thumb-image fi-loading"></div><div class="jFiler-item-info">'+file_desc+'</div>',
	...
	$.fn.filer.defaults = {
		...
		templates: {
			...
			item: '<li class="jFiler-item"><div class="jFiler-item-container"><div class="jFiler-item-inner"><div class="jFiler-item-icon pull-left">{{fi-name}}</div><div class="jFiler-item-info pull-left"><div class="jFiler-item-title" title="{{fi-name}}">{{fi-name | limitTo:30}}</div><div class="jFiler-item-others"><span>size: {{fi-size2}}</span><span>type: {{fi-extension}}</span><span class="jFiler-item-status">{{fi-progressBar}}</span></div><div class="jFiler-item-info pull-left">description:{{fi-desc}}</div><div class="jFiler-item-assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></div></div></div></div></li>',
			itemAppend: '<li class="jFiler-item"><div class="jFiler-item-container"><div class="jFiler-item-inner"><div class="jFiler-item-icon pull-left">{{fi-name}}</div><div class="jFiler-item-info pull-left"><div class="jFiler-item-title">{{fi-name | limitTo:35}}</div><div class="jFiler-item-others"><span>size: {{fi-size2}}</span><span>type: {{fi-extension}}</span><span class="jFiler-item-status"></span></div><div class="jFiler-item-info pull-left">description:{{fi-desc}}</div><div class="jFiler-item-assets"><ul class="list-inline"><li><a class="icon-jfi-trash jFiler-item-trash-action"></a></li></ul></div></div></div></div></li>',
