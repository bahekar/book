    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="btn-toolbar">
                <a href="add_magazine" class="btn btn-primary btn-sign-in"><i class="icon-plus"></i> Add Magazine</a>
            </div>
...
<script type="text/javascript">
    ...
    function childserviceload() {
        $('#tt').datagrid({
            url: 'get_single_upload_list?type=3',
    ...
    function editcontent(id){
        window.location="edit_magazine?id="+id;
    }
