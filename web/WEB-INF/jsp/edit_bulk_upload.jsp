<%@include file="header.jsp" %>   
    ...
    <div class="content">
        <div class="header">
            <h1 class="page-title">Edit Bulk Upload</h1>
        </div>
        <ul class="breadcrumb">
            <li><a href="home">Home</a> <span class="divider">/</span></li>
            <li><a href="">Edit Bulk Upload</a> <span class="divider">/</span></li>
        </ul>
					...
					<div class="row-fluid">
						<div class="span6">
							<div class="span4">Release Date</div>
                                                        <input type="text" id="release_date" name="release_date" placeholder="Release Date" class="input-xlarge">
						</div>
						<div class="span6">
							<div class="span4">Expiry Date</div>
                                                        <input type="text" id="expiry_date" name="expiry_date" placeholder="Expiry Date" class="input-xlarge">
						</div>
					</div>
...
category_id();
    ...
    {
        $("#contentname").val(obj.content_name);
        $("#content_type_id").val(obj.content_type_id);
        $("#code").val(obj.code);
        $("#category_id").val(obj.category_id);
        get_sub_category(obj.category_id);
        $("#sub_category_id").val(obj.sub_category_id);
        $("#provider_code").val(obj.provider_code);
        $("#keyword").val(obj.keyword);
        $("#release_date").val(obj.release_date);
                       ...
                       //alert(content);
                        $.ajax({
                            ...
                            {                      
                                ...
                                if (code == 0) {
                                    swal({title: "Success", text: "Bulk Content updated Successfully", imageUrl: "resources/images/thumbs-up.jpg"}, function (isConfirm) {
                                        if (isConfirm) {
