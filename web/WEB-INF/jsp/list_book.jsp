...
<div class="content">
    <div class="header">
        <h1 class="page-title">List Books</h1>
    </div>
    <ul class="breadcrumb">
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="btn-toolbar">
                <a href="add_book" class="btn btn-primary btn-sign-in"><i class="icon-plus"></i> Add Book</a>
            </div>
...
<script type="text/javascript">
    ...
    function checkchildserviceload() {
        ...
        htmocontent = htmocontent + '<th>Book Title</th>';
